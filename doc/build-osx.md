...
====================================
This guide will show you how to build costlyd (headless client) for OSX.
...
4.  (Optional) You can also install costlyd to your path:
...
4. Enter "costly-qt" as project name, enter src/qt as location
...
------------------------
You can ignore this section if you are building `costlyd` for your own use.
...
Once dependencies are compiled, see [doc/release-process.md](release-process.md) for how the Costly Core
bundle is packaged and signed to create the .dmg disk image that is distributed.

Running
-------

It's now available at `./costlyd`, provided that you are still in the `src`
...
-------
    ...
    ./costlyd -daemon # to start the costly daemon.
    ./costly-cli --help  # for a list of command-line options.
    ./costly-cli help    # When the daemon is running, to get a list of RPC commands
