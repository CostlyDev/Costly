...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CostlyNetwork") type = CostlyNetwork;
    if(strType == "CostlyNetworkVariable") type = CostlyNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CostlyNetwork) s = "CostlyNetwork";
    if(type == CostlyNetworkVariable) s = "CostlyNetworkVariable";
