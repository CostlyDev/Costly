    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Costly Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Costly address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and costly: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Costly Core"), this);
    aboutAction->setStatusTip(tr("Show information about Costly Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Costly Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Costly addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Costly addresses"));
    ...
    openAction->setStatusTip(tr("Open a costly: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Costly Core help message to get a list with possible Costly Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Costly Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Costly network", "", count));
}
...
{
    QString strTitle = tr("Costly Core"); // default title
