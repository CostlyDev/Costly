...
This mechanism has been integrated into Bitcore-Node-Costly which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/costlypay/insight-api-costly#web-socket-api](https://github.com/costlypay/insight-api-costly#web-socket-api) 
* API: [https://github.com/costlypay/insight-api-costly#instantsend-transactions](https://github.com/costlypay/insight-api-costly#instantsend-transactions) 
...
By default, the Costly Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Costly Core daemon:
