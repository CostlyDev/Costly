...
<context>
    ...
    <message>
        ...
        <translation>Изменить параметры конфигурации Costly</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Автоматически запускать Costly после входа в систему.</translation>
    </message>
    <message>
        <source>&amp;Start Costly on system login</source>
        <translation>&amp;Запускать Costly при входе в систему</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Автоматически открыть порт для клиента Costly на роутере. Работает только в том случае, если Ваш роутер поддерживает UPnP и данная функция включена.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Здесь можно выбрать язык интерфейса. Настройки вступят в силу после перезапуска Costly.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Открыть отладочный лог-файл Costly из текущего каталога данных. Для больших лог-файлов эта операция может занять несколько секунд.</translation>
    </message>
    <message>
        <source>&amp;Open</source>
    ...
    <message>
        ...
        <translation>Добро пожаловать в RPC-консоль Costly.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>InstantX пока что не поддерживает такие большие суммы. На данный момент транзакции ограничены суммами до %1 CST.</translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>Отключить всю функциональность, относящуюся к  Costly (Мастерноды, Darksend, InstantX, бюджеты) (0-1, по умолчанию: %u)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссии (в CST/Kb) меньше этого значения считаются нулевой для ретранслирования транзакции (по умолчанию: %s)</translation>
    </message>
    <message>
        <source>Fees (in CST/Kb) smaller than this are considered zero fee for transaction creation (default: %s)</source>
        <translation>Комиссии (в CST/Kb) меньше этого значения считаются нулевой (для создания транзакции) (по умолчанию: %s)</translation>
    </message>
    <message>
...
for example: alertnotify=echo %%s | mail -s "Costly Alert" admin@foo.com
        ...
        <translation>Для использования costlyd или опции -server с costly-qt, вы должны установить опцию rpcpassword в конфигурационном файле:
%s
...
Например: alertnotify=echo %%s | mail -s "Costly Alert" admin@foo.com
</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Внимание: пожалуйста, убедитесь что дата и время на Вашем компьютере выставлены правильно! Costly Core не сможет работать корректно, если часы настроены неверно.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Комиссии (в CST/kB), добавляемая к отправляемым Вами транзакциям (по умолчанию: %s)</translation>
    </message>
    <message>
