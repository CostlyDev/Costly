 ...
 *
 *   // network
 *   CCostlyNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.costly.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCostlyNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: CostlyNetwork
// //   -- signature requirements : Key1(User)
// class CCostlyNetworkVariable : public CGovernanceObject
// {
// private:
