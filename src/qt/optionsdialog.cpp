    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("CST-light"), QVariant("light"));
    ui->theme->addItem(QString("CST-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("CST-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("CST-traditional"), QVariant("trad"));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->anonymizeCostly, OptionsModel::AnonymizeCostlyAmount);
