    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Costly Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Costly Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  costly-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Costly in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 CST, 0.1 CST, 1 CST and 10 CST -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://costlypay.atlassian.net/wiki/display/DOC/PrivateSend\">https://costlypay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Costly Core is shutting down...") + "<br /><br />" +
